...
<%
	...
	if(emailChecked == false){;
		PrintWriter script = response.getWriter();
		script.println("<script>");
		script.println("location.href = 'emailSendConfirm.jsp';"); //이메일 인증이 되지않은 회원에게 이메일을 재확인 받는 페이지
		script.println("</script>");
		script.close();
		return;
	}
...
%>
			...
			<form action="./index.jsp" method="get" class="form-inline my-2 my-lg-0">
				<input type="text" name="search" class="form-control mr-ms-2" type="search" placeholder="내용을 입력하세요." aria-label="Search">
...
%>		
	<div class="card bg-light mt-3">
		<div class="card-header bg-light">
			<div class="row">
				<div class="col-8 text-left"><%= evaluation.getLectureName() %>&nbsp;<small> - <%= evaluation.getProfessorName() %> 교수님</small></div>
				<div class="col-4 text-right">
					종합 [ <span style="color: red;"><%= evaluation.getTotalScroe() %></span> ]
				</div>
			</div>
		</div>
		<div class="card-body">
...
%>	
	<a class="page-link" href="./index.jsp?lectureDivde=<%=URLEncoder.encode(lectureDivide, "UTF-8")%>&searchType= 
...
%>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="./evaluationRegisterAction.jsp" method="post">
						<!-- form-row의 경우는 하나의 행을 여러개로 나눌때 사용 -->
						<div class="form-row">
	...
	<footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF;">
		Copyright &copy; 2021 이경훈All Rights Reserved.
	</footer>
	<!-- 제이쿼리 자바스트립트 추가하기 -->
